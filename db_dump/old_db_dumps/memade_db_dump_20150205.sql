...
--
-- Host: localhost
-- Generation Time: Feb 05, 2015 at 01:33 PM
...
(2, 'Testing', '', 'menu-main-menu', NULL, 0),
(7, 'Menu Title', '', 'menu-main-menu', NULL, 0),
(9, 'Work', '', 'menu-main-menu', NULL, 1),
(14, 'test3', '', 'menu-main-menu', NULL, 0),
(15, 'test7', 'pageid=52', 'menu-main-menu', NULL, 0),
(16, 'test8', 'pageid=', 'menu-main-menu', NULL, 0),
(17, 'test9', 'pageid=54', 'menu-main-menu', NULL, 0);
...
--
ALTER TABLE `menu_links`
  MODIFY `mlid` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=18;
--
